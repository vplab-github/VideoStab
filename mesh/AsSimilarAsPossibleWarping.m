...
%                 i
               ...
               obj.dataterm_element_i(i) = min(floor(pt.y/obj.quadHeight)+1,obj.source.meshWidth-1);
               obj.dataterm_element_j(i) = min(floor(pt.x/obj.quadWidth)+1,obj.destin.meshWidth-1);
               %% quit if obj.dataterm_element_i(i)==obj.source.meshWidth
               if floor(pt.y/obj.quadHeight)+1==obj.source.meshWidth || floor(pt.x/obj.quadWidth)+1==obj.destin.meshWidth
                   k=1;
               end
